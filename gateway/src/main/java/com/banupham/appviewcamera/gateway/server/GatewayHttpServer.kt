...
class GatewayHttpServer(
    ...
    private suspend fun status(): HttpResponse {
        ...
        return HttpResponse.json(200, JSONObject().apply {
            ...
            put("mediamtx", JSONObject().put("state", runtime.rtspState).put("implementation", "android-rtsp-proxy"))
            put("rtsp_proxy", JSONObject().put("state", runtime.rtspState).put("active_clients", runtime.activeRtspClients))
